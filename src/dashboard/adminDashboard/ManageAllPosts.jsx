...
const ManageAllPosts = () => {
     ...
     const [posts, setPosts] = useState([]);
      ...
      useEffect(() => {
        ...
        fetch("https://volunteer-management-server.onrender.com/volunteer") 
          .then((res) => res.json())
       ...
       const handlePostDelete= id => {
          ...
          fetch(`https://volunteer-management-server.onrender.com/volunteer/${id}`, {
              method:'DELETE'
              })
              .then(res => res.json())
              .then(data => {
        ...
        <tbody>
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <td className='font-semibold sm:text-base md:text-lg lg:text-lg '>{post.
organizer_email} </td>
